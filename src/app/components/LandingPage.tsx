      ...
      <div className="h-screen dark:bg-dot-white/[0.2] bg-dot-black/[0.2]">
        ...
        <div id="home" className="mt-20">
          <div className="w-[calc(100%-4rem)] mx-auto rounded-3xl h-[35rem] overflow-hidden flex-1 mt-10 md:mt-0">
            ...
            >
              <h2 className="text-white text-2xl md:text-6xl font-bold text-center rubik-vinyl">
                Ek Noor Services
              </h2>
              <p className="text-white text-sm md:text-2xl max-w-xl mt-6 text-center roboto-mono">
