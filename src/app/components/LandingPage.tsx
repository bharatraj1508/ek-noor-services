...
export default function LandingPage() {
  ...
  return (
    <>
      <div className="w-[calc(100%-4rem)] mx-auto rounded-3xl h-[30rem] overflow-hidden flex-1 mt-10 md:mt-0">
        <Vortex
      ...
      <div className="flex flex-col gap-y-10 mt-10">
        ...
        <div className="relative overflow-hidden bg-gradient-to-r from-purple-800 to-purple-500 text-white mx-5 rounded-lg shadow-lg">
          <div className="flex space-x-10 marquee whitespace-nowrap">
            ...
            <span className="text-lg font-semibold with-bullet">Pan Card</span>
            <span className="text-lg font-semibold with-bullet">
              Ayushman Card
            </span>
            <span className="text-lg font-semibold with-bullet">
            ...
            <span className="text-lg font-semibold with-bullet">Abha Card</span>
